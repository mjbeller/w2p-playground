...
# copied from http://www.web2pyslices.com/slice/show/1542/manage-users-and-memebership-in-the-same-form
...
# try something like
def index(): return dict(message="hello from list_detail_form.py")
